...
router.get("/me/invites", c.getMyInvites);
...
router.post("/:id/join-requests", c.requestToJoin);
router.get("/:id/join-requests", c.getJoinRequests);
router.post("/:id/join-requests/:userId/accept", c.acceptJoinRequest);
router.post("/:id/join-requests/:userId/reject", c.rejectJoinRequest);
router.post("/:id/invites", validate(addMemberValidations), c.inviteMember);
router.post("/:id/invites/accept", c.acceptInvite);
router.post("/:id/invites/reject", c.rejectInvite);
router.delete("/:id/leave", c.leaveFamily);
